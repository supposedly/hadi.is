...
There isn't much else to it. `AND` is "this flag/argument needs these other flags/arguments", `OR` is "this flargument is
...
I'm not the first to think of that by a long shot, but it turns out it's a pretty useful way of thinking about a lot
