...
```py
>>> cli.parse('foo -S "test test" -vvvv')
...
>>> 
>>> cli.parse('foo -a')  # same as `foo --add`
...
of things. An iteration of the same idea is informing a huge part of the dictionary at
<ArticleLink n="lebnxyz">lebn.xyz</ArticleLink>!
