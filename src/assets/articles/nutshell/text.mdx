...
So Golly, the software from earlier, actually lets you explore all kinds of different ones
...
(I don't have any practical use for it, but it's easy to model and it looks pretty cool.) And then, with a good 4 months of
