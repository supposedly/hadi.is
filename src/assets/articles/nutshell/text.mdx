...
describe any CA that Golly could possibly simulate... but it's pretty primitive. Just way lower-level than is
helpful sometimes, and it loves making you repeat yourself.
...
which I don't have any practical use for, but it's easy to model and it looks pretty cool. And then, after a good 4 months of
