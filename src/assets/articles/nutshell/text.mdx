...
and, boy, does that not sound like a fun time. So I took the sensible way out:
[I wrote over 3,000 lines of code instead.](https://xkcd.com/1319/)

Long story short, it worked super well, and over to the right is the very first rule I ever compiled with Nutshell: the
